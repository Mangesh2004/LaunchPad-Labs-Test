  ...
  return (
    <section className="flex w-full flex-col items-center bg-white px-6 py-24">
      <div className="flex w-full max-w-5xl flex-col items-center text-center">
        ...
        <h2
          className="mt-8 text-[28px] font-semibold leading-[31px] text-[#202020]"
          style={{ fontFamily: '"Plus Jakarta Sans", var(--font-sans)' }}
        >
        ...
        <p
          className="mt-4 max-w-[580px] text-center text-[16px] font-medium leading-[31px] text-[#525252]"
          style={{ fontFamily: '"Plus Jakarta Sans", var(--font-sans)' }}
        >
          A transparent, founder-friendly journey from idea to live MVP in just 2
          weeks.
        </p>
      </div>

      <div className="mt-16 flex w-full max-w-[1228px] flex-col items-center gap-[45px]">
...
const ProcessCard = ({ step }: { step: ProcessStep }) => {
  ...
  return (
    <article
      className="relative flex flex-col rounded-[16px] bg-white px-6 pb-6 pt-4 shadow-[0_2px_21px_rgba(0,0,0,0.1)]"
