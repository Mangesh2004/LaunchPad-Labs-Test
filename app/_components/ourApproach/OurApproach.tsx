  ...
  return (
    <section className="flex w-full flex-col items-center bg-[#F3F7F8] px-6 py-24">
      <div className="flex w-full max-w-5xl flex-col items-center text-center">
        ...
        <h2
          className="mt-8 max-w-3xl text-[24px] font-semibold leading-[38px] text-[#202020]"
          style={{ fontFamily: '"Plus Jakarta Sans", var(--font-sans)' }}
        >
      ...
      <div className="mt-16 flex w-full max-w-[1100px] flex-col items-center gap-10 lg:flex-row lg:items-stretch lg:justify-between">
        <ApproachPanel
      ...
      <div className="mt-16 rounded-[31px] bg-[linear-gradient(90deg,#9CC6FF_0%,#00D0FF_100%)] p-px">
        <button
          className="inline-flex cursor-pointer h-12 items-center justify-center rounded-[31px] bg-[linear-gradient(0deg,#0F93FF_0%,#003BB9_100%)] px-10 text-[16px] font-semibold text-white shadow-[0_2px_4px_rgba(30,113,229,0.15),0_7px_7px_rgba(30,113,229,0.13),0_17px_10px_rgba(30,113,229,0.08),0_30px_12px_rgba(30,113,229,0.02)]"
          style={{ fontFamily: '"Plus Jakarta Sans", var(--font-sans)' }}
          type="button"
        >
...
const ApproachPanel = ({
  ...
  return (
    <div
      className={`flex h-[411px] w-full max-w-[458px] bg-transparent flex-col rounded-[20px] border-2 border-dashed ${
